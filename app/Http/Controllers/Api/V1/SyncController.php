...
class SyncController extends Controller
{
    ...
    public function pushLogs(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'logs.*.entity_type' => 'required|string|in:activity,verification_event,evidence',
    ...
    public function pullDeltas(Request $request): JsonResponse
    {
        ...
        $activities = Activity::where('updated_at', '>=', $timestamp)->get();
        $verifications = VerificationEvent::where('updated_at', '>=', $timestamp)->get();
